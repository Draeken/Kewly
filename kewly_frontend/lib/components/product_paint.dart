...
class ProductPaintHelper {
  ...
  static getGradient(Product product) {
    final compos = product.composition
    ...
    final colors = compos
        ...
        .toList(growable: false);
    final colorStops = _getColorStops(product, compos);
   ...
   */
  static List<Color> _getAdjustedColors(List<Composition> compos) {
...
class GlassEffect {
  ...
  static final ui.Picture ice = getEffectIce(Size(100, 100));
}
